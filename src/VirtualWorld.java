...
public final class VirtualWorld extends PApplet {
    ...
    */
    ...
    public void mousePressed() {
        ...
        points.add(new Point(pressed.x, pressed.y));
        points.add(new Point(pressed.x+1, pressed.y));
        ...
        // public Background(String id, List<PImage> images) {
            world.setBackgroundCell(p, new Background(" ", imageStore.getImageList("block")));
            world.setBackgroundCell(pressed,new Background(" ", imageStore.getImageList("block" )));
        }
        Entity bowser = new Bowser(world.getBowserKey(), pressed,imageStore.getImageList(world.getBowserKey()), 0.1, 0.2
        );
        world.tryAddEntity(bowser);
        bowser.scheduleActions(scheduler,world,imageStore);
