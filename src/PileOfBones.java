...
public class PileOfBones extends Entity implements Exeggutor, Movers {
    ...
    public PileOfBones(String id, Point position, List<PImage> images, double animationPeriod, double actionPeriod) {
...
//     public Sapling(String id, Point position, List<PImage> images, int health, double actionPeriod){
                Entity sapling = new Sapling(world.getSaplingKey() + "_" + bowserOpp.get().getId(), tgtPos, imageStore.getImageList(world.getSaplingKey()), 0);
