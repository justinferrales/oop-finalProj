...
public class Block extends Entity implements Exeggutor, Movers{
    ...
    public Block(String id, Point position, List<PImage> images, double animationPeriod, double actionPeriod){
...
// some sort of predicate that returns a boolean
    ...
    public void executeActivity(WorldModel world, ImageStore imageStore, EventScheduler scheduler) {
        Optional<Entity> fairyTarget = findNearest(world, this.getPosition(), new ArrayList<>(List.of(Fairy.class)));
